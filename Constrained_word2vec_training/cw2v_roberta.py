...
parser.add_argument("--dataset_file", type=str, default="code_mix_dict_tokenization_2M")
...
wandb.init(project="constrained_word2vec_train_roberta", entity="nandinimundra", name = f"{args.dataset_file}_{args.threshold}_{args.batch_size}_{args.learning_rate}_{args.window_size}_{args.neg_sample}_{args.weight_decay}")
...
folder_name = f"weights_{args.dataset_file}_{args.threshold}_{args.batch_size}_{args.learning_rate}_{args.window_size}__{args.neg_sample}_{args.weight_decay}"
...
for epoch in range(0, n_epochs):
    ...
    tokenizer = AutoTokenizer.from_pretrained('/data/nandini/vocab_adapt/codes/BERT/extended_llama_roberta/', use_fast = True)
