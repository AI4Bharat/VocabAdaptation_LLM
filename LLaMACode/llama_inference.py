...
parser.add_argument("--run_name", default="model_indicllama_IW_wikitionary_correct")
...
config = AutoConfig.from_pretrained("./config_indicLLma_IW_wikitionary_correct/", trust_remote_code=True)

# config.init_device = 'cuda:0' # For fast initialization directly on GPU!
model_kwargs = {"device_map": "auto"}
model = AutoModelForCausalLM.from_pretrained(
  "./model_indicllama_IW_wikitionary_correct/",
  config=config,
...
tokenizer = AutoTokenizer.from_pretrained("indic_llama_hf_m_filter")
