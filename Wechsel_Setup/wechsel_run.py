...
parser.add_argument('--align_strategy', default="bilingual_dictionary", type=str, help="None || bilingual_dictionary") 
parser.add_argument('--embmatrix', default="lmhead", type=str, help="lmhead || emb") 
parser.add_argument('--bilingual_dictionary_path', default="/nlsasfs/home/ai4bharat/nandinim/nandini/vocab_adap/combine_bilingual_dict_wikitionary.txt", type=str)
# parser.add_argument('--bilingual_dictionary_path', default="", type=str)
...
parser.add_argument('--output_path', default="/nlsasfs/home/ai4bharat/nandinim/nandini/vocab_adap/trained_fasttext/embed/indicllama_lmhead_128k_wechsel_dict_wikitionary.pt", type=str)
...
if args.align_strategy == None:
  ...
  print("alugn strategy: dictionary")
  wechsel = WECHSEL(
    load_embeddings(args.source_fasttext_bin),
    load_embeddings(args.target_fasttext_bin),
...
if args.embmatrix == "lmhead":
  print("emb matrix: lmhead")
  target_embeddings, info = wechsel.apply(
    source_tokenizer,
    target_tokenizer,
    model.state_dict()['lm_head.weight'].clone().numpy(),
    
)
else:
  print("embmatrix: embedding")
  target_embeddings, info = wechsel.apply(
    source_tokenizer,
    target_tokenizer,
